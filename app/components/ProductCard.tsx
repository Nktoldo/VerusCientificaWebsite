...
export default function ProductCard({name, image, subtitle, onClick}: {name: string, image: string, subtitle: string, onClick?: () => void}) {
    ...
    return(
        <div 
            className="group relative w-full aspect-[4/3] lg:min-h-[320px] overflow-hidden rounded-2xl bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/40 shadow-lg shadow-blue-500/10 border border-blue-200/40 hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105 hover:-translate-y-2 transition-all duration-500 cursor-pointer flex flex-col"
            onClick={onClick}
        >
                ...
                {hasImage ? (
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-center">
                            <div className="w-16 h-16 sm:w-20 sm:h-20 lg:w-24 lg:h-24 mx-auto mb-2 rounded-full bg-gradient-to-br from-blue-200 to-indigo-300 flex items-center justify-center">
