...
export default function ProductCard({name, image, subtitle, onClick}: {name: string, image: string, subtitle: string, onClick?: () => void}) {
    ...
    return(
        <div 
            className="group relative w-full h-100 overflow-hidden rounded-2xl bg-gradient-to-br from-white via-blue-50/30 to-indigo-50/40 shadow-lg shadow-blue-500/10 border border-blue-200/40 hover:shadow-2xl hover:shadow-blue-500/20 hover:scale-105 hover:-translate-y-2 transition-all duration-500 cursor-pointer flex flex-col"
            onClick={onClick}
        >
